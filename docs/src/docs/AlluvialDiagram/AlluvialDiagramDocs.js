...
const examples = [
  {
    id: "basic",
    label: "Basic AlluvialDiagram",
    codeText: require('raw-loader!./examples/AlluvialDiagram.js.example'),
  },
];

export default class AlluvialDiagramExamples extends React.Component {
  render() {
    return <ComponentDocs name="AlluvialDiagram" propDocs={propDocs}>
